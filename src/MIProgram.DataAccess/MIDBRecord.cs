...
namespace MIProgram.DataAccess
{
    [DelimitedRecord("|")]
    [IgnoreEmptyLines]
    public class MIDBRecord : IMIDBRecord<Album>
    {
        private MIDBRecord() {}
        ...
        public MIDBRecord(MIXmlRecord record)
        : this(record.Id, record.CreationDate, record.Title, record.Text, record.ReviewerName, record.ReviewerMail,
            record.Score, record.CoverFileName, record.OfficialUrl, record.OfficialUrlTitle, record.Hits, null, null, null)
        { }
