...
namespace MIProgram.Core.Model
{
    public class Artist
    {
        ...
        public string ToRailsInsert()
        {
            ...
            sb.AppendFormat("{0}.assign_attributes({{ id: {1}, name: '{2}', practices_attributes: [{{:kind => :band, created_at: DateTime.parse('{4}'), updated_at: DateTime.parse('{5}')}}], countries: [{3}], created_at: DateTime.parse('{4}'), updated_at: DateTime.parse('{5}'), creator_id: {6}, updater_id: {6}, published: true }}, :without_protection => true)",
